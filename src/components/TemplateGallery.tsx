      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-12 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {filtered.map((t, i) => (
            <div
              key={t.id}
              className="reveal group relative flex flex-col overflow-hidden rounded-2xl border border-white/10 bg-white/[0.03] p-4 transition-all duration-500 hover:-translate-y-2 hover:border-white/25 hover:shadow-[0_20px_50px_-15px_rgba(139,92,246,0.3)]"
